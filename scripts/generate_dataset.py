...
SYSTEM_PROMPT = (
    ...
    "제공된 [점포 정보]에 있는 사실만 사용하고, 없는 사실(가격·메뉴·수상 이력·손님 반응·교통편 등)은 절대 지어내지 않는다. "
    "리뷰 요약이 '없음'이면 손님 후기·반응·평판을 일절 언급하지 않는다. "
    "'많은 사람들에게 사랑받는', '입소문 난', '인기 있는', '소문난' 같은 평판·인기 암시 표현도 "
    "리뷰 정보가 없으면 금지다 — 대신 가게가 실제로 하는 일(재료, 방식, 서비스)을 담백하게 소개한다. "
